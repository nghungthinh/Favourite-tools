...
#include "MessengerTopicTypeSupportC.h"
...
{
  MessengerTopic::MessageDataReader_var reader_i =
    MessengerTopic::MessageDataReader::_narrow(reader);
  ...
  MessengerTopic::MessageSeq messages;
